...
public class DrawerMenu {
    ...
    public ArrayList<DrawerMenuItem> createDrawerNawiItem(Context context) {
        ...
        items.add(new DrawerMenuItem(Constants.STORIES_ID, context.getDrawable(R.drawable.ic_forum_black_24dp), context.getResources().getString(R.string.stories_item)));
        items.add(new DrawerMenuItem(Constants.MESSAGES_ID, context.getDrawable(R.drawable.ic_email_black_24dp), context.getResources().getString(R.string.messages_item), 7));
        items.add(new DrawerMenuItem(Constants.GALLERY_ID, context.getDrawable(R.drawable.ic_image_black_24dp), context.getResources().getString(R.string.gallery_item)));
        items.add(new DrawerMenuItem(Constants.EVENT_ID, context.getDrawable(R.drawable.ic_event_note_black_24dp), context.getResources().getString(R.string.event_item), 12));
        items.add(new DrawerMenuItem(Constants.PEOPLE_ID, context.getDrawable(R.drawable.ic_group_black_24dp), context.getResources().getString(R.string.people_item)));
